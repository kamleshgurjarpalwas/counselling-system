      ...
      <Table className="w-full border border-gray-200 rounded-lg table-fixed">
        <TableHeader className="bg-gray-100 text-gray-700">
          <TableRow className="border-b border-gray-300">
            ...
            <TableHead className="border p-3 px-5 w-[110px] break-words whitespace-normal overflow-hidden">HS - Opening Rank</TableHead>
            <TableHead className="border p-3 px-5 w-[110px] break-words whitespace-normal overflow-hidden">HS - Closing Rank</TableHead>
            <TableHead className="border p-3 px-5 w-[110px] break-words whitespace-normal overflow-hidden">OS - Opening Rank</TableHead>
            ...
            college.branches.map((branch) =>
              Object.keys(branch.categories).map((category) => (
                ...
                >
                  ...
                  <TableCell className="border p-3 px-5 w-[110px] break-words whitespace-normal overflow-hidden">{branch.categories[category].homeState.openingRank || "N/A"}</TableCell>
                  ...
                  <TableCell className="border p-3 px-5 w-[110px] break-words whitespace-normal overflow-hidden">{branch.categories[category].otherState.openingRank || "N/A"}</TableCell>
