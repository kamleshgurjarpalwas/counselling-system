/*const newsData = [
  ...
  {
    id: 4,
    title: "Important: Last Date for Application",
    date: "Feb 25, 2025",
  },
  ...
  {
    id: 8,
    title: "Steps to Change Institute Preferences",
    date: "Feb 21, 2025",
  },
  { id: 9, title: "Mock Allotment Results Released", date: "Feb 20, 2025" },
  {
    id: 10,
    title: "Final Seat Allotment Process Details",
    date: "Feb 19, 2025",
  },
  {
    id: 11,
    title: "Fee Payment Guidelines for 2025 Admissions",
    date: "Feb 18, 2025",
  },
  {
    id: 12,
    title: "Important: How to Check Allotment Status",
    date: "Feb 17, 2025",
  },
  {
    id: 13,
    title: "Withdrawal & Refund Policy Explained",
    date: "Feb 16, 2025",
  },
  {
    id: 14,
    title: "Reporting Instructions for Allotted Institutes",
    date: "Feb 15, 2025",
  },
  {
    id: 15,
    title: "Common Mistakes to Avoid in Counseling",
    date: "Feb 14, 2025",
  },
  {
    id: 16,
  ...
  {
    id: 17,
    title: "Helpdesk Support Extended for Applicants",
    date: "Feb 12, 2025",
  },
  {
    id: 18,
    title: "Online Counseling Portal Maintenance Notice",
    date: "Feb 11, 2025",
  },
  {
    id: 19,
    title: "How to Upload Documents for Verification",
    date: "Feb 10, 2025",
  },
  {
    id: 20,
    title: "Special Round Counseling Dates Announced",
    date: "Feb 9, 2025",
  },
];*/
      ...
      .then((data) =>
        setNewsData(
          data.updates.map((update, index) => ({
            id: index + 1, // Assigning unique IDs if not provided
            title: update.title,
            date: update.content || "Unknown Date", // Fallback in case date is missing
          }))
        )
      )
          ...
          <ul className="space-y-3">
            {newsData.length > 0 ? (
              newsData.map((news) => (
                <li
                  key={news.id}
                  className="p-2 cursor-pointer rounded border-b hover:bg-gray-200"
                >
