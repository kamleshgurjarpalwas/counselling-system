    ...
    <div className="relative bg-gradient-to-r from-blue-100 to-amber-50 py-16 px-6 text-center">
      ...
      >
        ...
        <p className="mt-4 text-lg text-gray-700">
          ...
          the Ministry of Education to manage and regulate joint seat allocation
          for <b className="font-semibold">121 institutes</b> for the academic
          year 2025-26.
        </p>
        ...
        <p className="mt-4 text-lg text-gray-700">
          ...
          <span className="font-semibold">
            23 IITs, 31 NITs, IIEST Shibpur, 26 IIITs
          </span>
          , and
          <span className="font-semibold">
            {" "}
        ...
        <div className="mt-8 space-x-4">
          ...
          <Button
            variant="outline"
            className="px-6 py-3 text-lg cursor-pointer border-gray-700 text-gray-700"
          >
            About Us
          </Button>
        </div>
